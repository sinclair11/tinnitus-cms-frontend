...
export const Endpoints = {
    ...
    API_ALBUM_SEARCH: `http://${host}/api/admin/albums/search`,
    ...
    API_PRESET_SEARCH: `http://${host}/api/admin/presets/search`,
    ...
    API_SAMPLE_CHECK: `http://${host}/api/admin/sample/check`,
    API_SAMPLE_SEARCH: `http://${host}/api/admin/samples/search`,
